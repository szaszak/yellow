...
# Resultado: camadas "Cleaned" e "Error". A camada "cleaned" tem o viário 
# segmentado por quadra.
...
# - Selecionar somente as colunas osm_id, name, highway, qgis_id  e length_m
