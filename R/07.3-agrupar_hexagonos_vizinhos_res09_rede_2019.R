...
# dados descritivos, vemos que essa distância, a 12 km/h equivale a 40 e é maior
# do que 95% dos deslocamentos (percentil 95% = 7.710 m).
...
hex_com_vizinhos <- lapply(hexagonos$id_hex, agregar_vizinhos, n_vizinhos = 23)
...
# Guardar resultados
out_file <- sprintf('%s/hex_spo_res09_23vizinhos.csv', pasta_hexagonos)
