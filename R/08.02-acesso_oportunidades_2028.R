...
ttmatrix <- sprintf('%s/ttmatrix_rede2028_res09_resultados_2019.csv', pasta_gh_ttmarix_2028)
...
ttmatrix %>% filter(id_hex_x == '89a8100eac3ffff')
hexagonos %>% filter(id_hex == '89a8100eac3ffff') %>% st_drop_geometry()
...
out_shape <- sprintf('%s/hex_agregado_oportunidades_res09_2028.gpkg', pasta_oportunidades)
