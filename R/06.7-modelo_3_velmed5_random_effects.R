...
out_png <- sprintf('%s/modelo_randomeffects_histogram.png', pasta_graficos)
...
out_png <- sprintf('%s/modelo_randomeffects_boxplot.png', pasta_graficos)
png(out_png, width = 600, height = 350)
...
for (i in seq(1, 5)) {
  ...
  out_png <- sprintf('%s/modelo_randomeffects_plot%i.png', pasta_graficos, i)
