...
# Exportar como:
# 04_atributos_viario / A3_listagem_curvatura_por_trecho_viario.csv
...
# - Separador é ponto e vírgula
# Exportar como:
# 04_atributos_viario / A4_A_listagem_lotes_por_trecho_de_viario.csv
...
# - Separador é ponto e vírgula
# Exportar como:
# 04_atributos_viario / A4_B_listagem_lotes_por_trecho_de_viario_15m.csv


# Repetir para 30 metros e exportar como
# Exportar como:
# 04_atributos_viario / A4_C_listagem_lotes_por_trecho_de_viario_30m.csv
...
# - Separador é ponto e vírgula
# Exportar como:
# 04_atributos_viario / A5_listagem_tipologia_de_viario_por_trecho.csv
...
# foram copiados como:
# 04_atributos_viario / A6_listagem_vias_infra_cicloviaria.csv
# 04_atributos_viario / A7_listagem_vias_em_areas_restritas.csv
...
# Exportar como CSV:
# - Selecionar somente as colunas osm_id, highway e as das tags extraídas acima
# - Separador é ponto e vírgula
# Exportar como:
# 04_atributos_viario / A8_listagem_tags_osm_de_viario.csv
