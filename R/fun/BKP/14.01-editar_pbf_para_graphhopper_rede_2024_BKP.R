...
dir.create(pasta_redes_testes, recursive = TRUE, showWarnings = FALSE)
...
# Testar resultados
st_write(ciclo_ciclov24, sprintf('%s/teste_ciclovias.gpkg', pasta_redes_testes), driver = 'GPKG', append = FALSE, delete_layer = TRUE)
...
# Testar resultados
st_write(ciclo_ciclofx24, sprintf('%s/teste_ciclofaixas.gpkg', pasta_redes_testes), driver = 'GPKG', append = FALSE, delete_layer = TRUE)
...
# Testar resultados
st_write(ciclo_2028, sprintf('%s/teste_rede2028_sem_2024.gpkg', pasta_redes_testes), driver = 'GPKG', append = FALSE, delete_layer = TRUE)
...
pbf_file_out  <- sprintf('%s/20220216_sao_paulo_edited_20250215_A_infraciclo_2024.osm.pbf', pasta_redes_24_28)
