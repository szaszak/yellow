...
out_file <- sprintf('%s/03_base_alternatives_2028_res09_40min.csv', pasta_aoprv_alter)
...
# head(that)
# 
out_file2 <- sprintf('%s/01_base_alternatives_2019_res09_40min.parquet', pasta_aoprv_alter)
