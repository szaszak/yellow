...
# dir.create(pasta_gh_ttmatrix_2028, recursive = TRUE, showWarnings = FALSE)
...
resultados_ttmatrix <- list.files(pasta_gh_ttmatrix_2028, pattern = '^ttmatrix_rede2028_res09_([0-9]){2}\\.csv', full.names = TRUE)
...
out_file <- sprintf('%s/ttmatrix_rede2028_res09_ids.csv', pasta_gh_ttmatrix_2028)
...
ids_ttmatrix <- sprintf('%s/ttmatrix_rede2028_res09_ids.csv', pasta_gh_ttmatrix_2028)
...
# Gravar resultados
out_file <- sprintf('%s/ttmatrix_rede2028_res09_resultados_2019.csv', pasta_gh_ttmatrix_2028)
write_delim(resultados_ttmatrix, out_file, delim = ';')
...
# 1st Qu.: 4615.73   1st Qu.: 1513.343   1st Qu.:10.815  
# Median : 6552.17   Median : 2137.758   Median :11.024  
# Mean   : 6369.30   Mean   : 2080.334   Mean   :11.007  
# 3rd Qu.: 8103.32   3rd Qu.: 2638.216   3rd Qu.:11.229  
# Max.   :43777.08   Max.   :14362.271   Max.   :13.314  
